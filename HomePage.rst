...
1. İstekte bulunan URL ClientID ve ClientKey ile birlikte missioncontrol.x.com a gider. Bunun amacı uı.x.com a gelen isteğin buraya        ulaşmasına izninin olup olmayacağının belirlenmesidir.
2. missioncontrol.x.com belirli claimsleri kullanarak UI a bir token üretir. 
3. x.com dan herhangi bir ödeme yapılmak istendiğinde payment.x.com istek atılır.
4. payment.x.com a gelen istek missioncontrol.x.com dan gerekli izne sahip mi diye sorgulanır
5. Gelen token ile birlikte x.com fail,success, reject olarak cevap dönülür.
...
- (*) missioncontrol.x.com, api.x.com, payment.x.com da olan tüm işlemler için log.x.com a kayıt atılır.
